...
import { ArrowRight, Pill, Tag, Package, Star } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
          <div className="animate-fade-in-up">
            ...
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground">
              Popular{" "}
              <span className="text-gradient-gold">Medicines</span>
            </h2>
            <p className="text-muted-foreground mt-3 max-w-lg text-lg">
              Classical and proprietary Ayurvedic medicines for holistic healing
            </p>
          </div>
          <Link
            to="/medicines"
